import { SDATA } from "../src/Container/constants/sales-analytics-data";
import { UDATA } from "../src/Container/constants/update-data";
import { RDATA } from "./Export";
...
const buildSalesAnalytics = (element) => {
  const salesAnalyticsData = { SDATA };
